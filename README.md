...
- `spora-ai/spora-plugin-media-archive` — browse, filter, and download images generated by this plugin. Ingestion is best-effort; if the plugin is absent, the tool returns a data URL fallback.